...
<div id = "my_content_display">
	<img id = "heart_mobile" class = "display" src = "/img/icons/button/favorite_on.png" > </img>
	<img id = "time_mobile" class = "display" src = "/img/icons/button/later_on.png" > </img>
	<img id = "medal_mobile" class = "display" src = "/img/icons/button/reco_on.png" > </img>
</div>
...
<section id = "information">
	...
	<div id = "information_header">
		...
		<span id = "info_title">
			<h1 class = "name" <?php display_admin($type_id, $content_id) ?> > <?php ECHO $content["name"] ?> 
				<img id = "heart_pc" class = "display" src = "/img/icons/button/favorite_on.png" > </img>
				<img id = "time_pc" class = "display" src = "/img/icons/button/later_on.png" > </img>
				<img id = "medal_pc" class = "display" src = "/img/icons/button/reco_on.png" > </img>
			</h1>
