<?php
    ...
    function image_format_of($type_id) {
        ...
        if ($type_id == "video") {$format = "panorama";}
    ...
    function title_of_category($category_id) {
        ...
        if ($category_id == 1) {$title = "Eveil des consciences";}
        if ($category_id == 2) {$title = "Alternatives concrètes";}
        if ($category_id == 3) {$title = "Media et communication";}
        if ($category_id == 4) {$title = "Santé et alimentation";}        
        if ($category_id == 5) {$title = "Écologie";}
        if ($category_id == 6) {$title = "Économie";}
        if ($category_id == 7) {$title = "Société";}
        if ($category_id == 8) {$title = "Connaissance";}
    ...
    function category_of($category_id) {
        ...
        if ($category_id == 3) {$category = "Esprit critique";}
        ...
        if ($category_id == 8) {$category = "Connaissance";}
    ...
    function category_id_of($category) {
        ...
        if ($category == "Esprit critique") {$category_id = 3;}
        ...
        if ($category == "Connaissance") {$category_id = 8;}
    ...
    function display_thumbnail_list($list_id, $type_id, $title, $content_list) {
        ...
        if ($list_size > 0) {
            ...
            else {$page_number = ceil($list_size / 4);}
