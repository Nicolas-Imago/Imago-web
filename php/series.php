...
require_once("mutual/session.php");
...
<div id = "screen">
    ...
    <img class = "background_image" <?php display_image("background") ?>  alt="image de fond">
    ...
    <section id = "filter_list">
        ...
        <div id = "season_list">
            <?php display_season() ?>
            <img id = "season_selector" src = "../img/icons/tvshow/season_selector_grey.png" alt="selecteur">
        </div>
...
<a <?php display_next() ?> > <img id = "page_right" src = "../img/icons/footer/page_right_grey.png" alt="suivant"></a>
<a <?php display_preview() ?> > <img id = "page_left" src = "../img/icons/footer/page_left_grey.png" alt="précédent"></a>
