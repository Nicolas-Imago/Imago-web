...
<div id = "screen">
    ...
    <img class = "cover_image" <?php display_image("cover") ?> alt="image de couverture">
    ...
    <section id = "link">
        ...
        <a target = "_blank" id = "vod_link" class = "link" <?php display_link("vod") ?> >
            <img id = "vod_image" class = "icons_image" <?php display_image("vod") ?> alt="vod">
        </a>

        <a target = "_blank" id = "dvd_link" class = "link" <?php display_link("dvd") ?> >
            <img id = "dvd_image" class = "icons_image" <?php display_image("dvd") ?> alt="dvd">
        </a>
